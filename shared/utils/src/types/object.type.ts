...
/** @description Serialized `position` format */
export type SerializedPosition = [number, number, number];

/** @description Serialized `rotation` format */
export type SerializedRotation = [number, number, number, EulerOrder];
