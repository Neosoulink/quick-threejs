...
export declare abstract class Scope {
     ...
     */
    abstract resolve(factory: ObjectFactory, source: Function, context: BuildContext): any;
    /**
...
export declare abstract class BuildContext {
    abstract resolve<T>(source: Function & {
        prototype: T;
    }): T;
    abstract build<T>(source: Function & {
        prototype: T;
